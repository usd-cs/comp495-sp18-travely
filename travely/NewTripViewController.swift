...
class NewTripViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    let placesOrigin = ["-", "Barcelona", "Beijing", "Dubai", "Honolulu", "London", "Moscow", "Munich", "New York City", "Rome", "San Diego", "Seattle", "Sydney"]
    let placesDestination = ["-", "Barcelona", "Beijing", "Dubai", "Honolulu", "London", "Moscow", "Munich", "New York City", "Rome", "San Diego", "Seattle", "Sydney"]
    ...
    override func viewDidLoad() {
        ...
        if mySettings == nil{
            mySettings = Settings(budgetSet: false, budgetAmount: 0.0, directFlightOnly: false, culturalActivitiesPrefference: 0, outdoorsActivitiesPrefference: 0, nightlifeActivitiesPrefference: 0, hotelRaiting: 0, amenitiesPrefferenceSelected: [String](), activitiesPrefferenceSelected: [String]())
        }
